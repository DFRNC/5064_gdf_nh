...
document.addEventListener("DOMContentLoaded", function () {
    window.addEventListener("load", (event) => {
        ...
        let calloutSubElements = [
            ...
            { target: '#popup_collout1-link2', btn: '#btn_collout1-link2', link: 'https://highways.sharepoint.com/:b:/s/CyberSecurityCentreofExcellence/EdVxkRrRzrpFvC1S1WnMcF4BmTs3X-O0Izh43EaSAxXZCw?e=OFMLEZ' },
            { target: '#popup_collout1-link3', btn: '#btn_collout1-link3', link: 'https://highways.sharepoint.com/:b:/s/CyberSecurityCentreofExcellence/EWzsA8BC5R1DvaAfi9H66tMBc6jICTDLOhu-RW7R5uebhw?e=zgpF41' },
        ]
